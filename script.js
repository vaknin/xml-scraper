    ...
    return new Promise(function (resolve) {
        ...
        fs.readFile(path, function (err, data) {
            ...
            function extract(string, end, field) {
                var i = d.indexOf(string);
                //Make sure the field exists
                var value = d.substring(i + string.length, d.indexOf(end, i + string.length));
                if (i == -1) {
                    value = 'null';
                }
                object[field] = value;
...
function start() {
    return __awaiter(this, void 0, void 0, function () {
        var xmls, _i, xmls_1, f;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getFileNames()];
                case 1:
                    xmls = _a.sent();
                    _i = 0, xmls_1 = xmls;
                    _a.label = 2;
                case 2:
                    if (!(_i < xmls_1.length)) return [3 /*break*/, 5];
                    f = xmls_1[_i];
                    return [4 /*yield*/, readFile(f)];
                case 3:
                    _a.sent();
